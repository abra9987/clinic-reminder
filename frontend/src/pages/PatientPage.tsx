      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-5 py-10">
        <div className="max-w-[380px] w-full">
          ...
          >
            <a
              href={icsUrl}
              className="group w-full flex items-center justify-center gap-2.5 bg-clinic-800 text-white py-4 rounded-xl font-semibold text-[0.95rem] hover:bg-clinic-900 active:scale-[0.98] transition-all shadow-lg shadow-clinic-800/20"
            >
